<?php
namespace PHLU\SolrSearch\Tests\Unit\Domain\Model;
...
/**
 * Testcase for Resource model:string
 */
class ResourceModel:stringTest extends \TYPO3\Flow\Tests\UnitTestCase {
