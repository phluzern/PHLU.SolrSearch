 ...
 * </code>
 */
class SolrHighlightViewHelper extends AbstractViewHelper {

	/**
	 * @param string $documentId
	 * @param object $highlightObjects All highlight objects from Solr
	 * @param string $field
	 *
	 * @return string
	 */
	public function render($documentId, $highlightObjects, $field) {
		$currentDocument = (array)$highlightObjects->$documentId;
		if (!empty($currentDocument[$field])) {
			return $currentDocument[$field][0];
		} else {
			return '';
		}
	}
